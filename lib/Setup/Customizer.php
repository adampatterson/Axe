...
class Customizer
{
    ...
    public function axe_theme_customize_register($wp_customize)
    {
        ...
        $wp_customize->add_section('axe_theme_layout_options', [
        ...
        // Container Size
        $wp_customize->add_setting('axe_container_type', [
            'default'           => 'container',
            'type'              => 'theme_mod',
        ...
        $wp_customize->add_control(new \WP_Customize_Control($wp_customize, 'axe_container_type', [
        ...
        // Sidebar Positioning
        $wp_customize->add_setting('axe_sidebar_position', [
            'default'           => 'right',
            'type'              => 'theme_mod',
        ...
        $wp_customize->add_control(new \WP_Customize_Control($wp_customize, 'axe_sidebar_position', [
