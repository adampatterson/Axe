 ...
 * Description: A custom WordPress nav walker class to implement the Bootstrap 4 navigation style in a custom theme
 *     using the WordPress built in menu manager. Author: Edward McIntyre - @twittem, WP Bootstrap, William Patton -
 * @pattonwebz Version: 4.3.0 Author URI: https://github.com/wp-bootstrap GitHub Plugin URI:
 *     https://github.com/wp-bootstrap/wp-bootstrap-navwalker GitHub Branch: master License: GPL-3.0+ License URI:
